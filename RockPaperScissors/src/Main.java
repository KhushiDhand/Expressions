...
public class Main {
    public static void main(String[] args) {
        ...
        if(userChoice.equals("r")) {            //if the random number is rock then these are the possiblities
            if (randomnumber == 0) {
        ...
        if (userChoice.equals("p")) {           //if the user choice is paper then these are the possiblities
            if (randomnumber == 0) {
        ...
        if (userChoice.equals("s")) {         //if the user choice is scissors then these are the possiblities
            if (randomnumber == 0) {
