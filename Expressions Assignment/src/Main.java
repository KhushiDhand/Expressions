public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println(((3) + (Math.pow(3,4))/5));
        System.out.println(3.0 + (81.0/5.0));
        ...
        System.out.println(-7 + 3 + Math.pow(2,3)/8);
        System.out.println(-4 + Math.pow(2,3)/8);
        ...
        System.out.println((((10) * (Math.sin(45))) + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((((10) * (Math.sin(45))) + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((((10) * (0.850903524534118424)) + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println(((8.50903524534118424) + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println(((10.50903524534118424) - Math.pow(Math.sqrt(25), 3)));
        System.out.println(((10.50903524534118424) - (Math.pow(Math.sqrt(25), 3))));
        System.out.println(((10.50903524534118424) - (Math.pow(5,3))));
        System.out.println(((10.50903524534118424) - (125)));
        System.out.println(10.50903524534118424 - 125);
        System.out.println(-114.49096475465892);
    }
}
